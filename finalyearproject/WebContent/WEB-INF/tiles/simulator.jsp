			...
			<div class="panel-head">
				<ul class="nav nav-tabs">
					...
					<li class="disabled"><a data-toggle="tab"
						id="overview-control" href="#overview">Results</a></li>
															...
															<sf:form class="form" method="post"
																...
																<tr>
																	<td><c:out value="${ listedEmployee.employeeId }" />
																		<sf:input hidden="true" type="number"
																			path="employeeId" name="employeeId"
											...
											<div class="col-md-12">
												...
												<form method="post"
													...
													<div class="row">
														<!-- submit buttons -->
														<div class="col-md-4">
															<button class="btn btn-primary" name="submit" value="1">Add 1</button>
														</div>
														<div class="col-md-4">
															<button class="btn btn-primary" name="submit" value="5">Add 5</button>
														</div>
														<div class="col-md-4">
															<button class="btn btn-primary" name="submit" value="10">Add 10</button>
							...
							<div class="col-md-8 col-md-offset-2">
								...
								<sf:form class="form" method="post"
									...
									<div class="form-group form-inline row">
										...
										<div class="col-md-4">
											<sf:input class="form-control" path="duration"
												name="duration" type="number" max="1000" min="1" />
										</div>
									</div>
									<div class="form-group form-inline row">
					...
					<div id="overview" class="tab-pane">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<table class="table">
											...
											<tr>
												<th>Actual</th>
												<td id="avgAht">${ summaryReport.avgAht }</td>
												<td id="avgAcw">${ summaryReport.avgAcw }</td>
												<td id="avgFcr">${ summaryReport.avgFcr }</td>
												<td id="avgCallQuality">${ summaryReport.avgCallQuality }</td>
												<td id="avgCustSat">${ summaryReport.avgCustSat }</td>
												<td id="avgNumCalls">${ summaryReport.avgNumCalls }</td>
											</tr>
											<tr>
												<th>Target</th>
												<td>600</td>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="centerBlock">
											<canvas class="chart" id="ahtBarChart" width="100"
												height="100"></canvas>
											<canvas class="chart" id="acwBarChart" width="100"
												height="100"></canvas>
											<canvas class="chart" id="callQBarChart" width="100"
												height="100"></canvas>
											<canvas class="chart" id="fcrBarChart" width="100"
												height="100"></canvas>
											<canvas class="chart" id="custSatBarChart" width="100"
												height="100"></canvas>
											<canvas class="chart" id="numCallsBarChart" width="100"
												height="100"></canvas>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<h5>Employee Performance Breakdown</h5>
										<table class="table">
											<tr>
												<th>Very good</th>
												<th>Good</th>
											...
											<tr>
												<td>${ summaryReport.countVG }</td>
												<td>${ summaryReport.countG }</td>
												<td>${ summaryReport.countAvg }</td>
												<td>${ summaryReport.countB }</td>
												<td>${ summaryReport.countVB }</td>
											</tr>
										</table>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="centerBlock">
											<canvas class="chart" id="employeePieChart" width="400"
												height="400"></canvas>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<table class="table">
											<c:forEach items="${ simEmployees }" var="simEmployee">
												<tr>
													<td class="employee"><a
														href="${ pageContext.request.contextPath }/simulator/${ summaryReport.simId }/employee/${ simEmployee.employeeId }/1">View
															Report for Agent: <c:out
																value="${ simEmployee.employeeId}"></c:out>
													</a></td>
												</tr>
											</c:forEach>
